...
import { supabaseSecurityStorage, checkSecurityTablesExist } from "../../server/db-supabase.js";
import { addSetupEndpoints } from "../../server/setup-api.js";
...
import { securityStorage, issueAdminToken, verifyAdminToken } from '../../server/security.js';
import { registerInventoryRoutes } from "../../server/inventory-routes.js";
import { hybridUploadService } from '../../server/hybrid-upload-service.js';
import { googleDriveService } from '../../server/google-drive-service.js';
import { setupCaptainSystem } from '../../server/captain-system.js';
...
import { calculateSharedPrice, type SharedPricingOptions } from '../../shared/pricing.js';
import { z } from 'zod';
import {
...
} from '../../shared/smart-notifications-schema.js';
import { AutomaticNotificationService } from '../../server/automatic-notifications.js';
import { Vonage } from '@vonage/server-sdk';
import { twilioSMSService } from '../../server/twilio-service.js';
import { initializeMessageCentralSMS } from '../../server/message-central-service.js';
...
import { insertProductSchema, insertOrderSchema, insertPrintJobSchema, insertSecureAdminSchema, insertSecureDriverSchema, insertSecurityLogSchema } from "../../shared/schema.js";
import { z } from "zod";
import ServerPDFCompression from "../../server/pdf-compression-service.js";
...
• معلق: ${orders.filter(o => o.status === 'pending').length}`;
  ...
  const { createPaymobPayment, handlePaymobCallback, getPaymobPaymentMethods } = await import('../../server/paymob.js');
  ...
  app.get('/api/payments/paymob/test', async (req, res) => {
    try {
      const paymobModule = await import('../../server/paymob.js');
