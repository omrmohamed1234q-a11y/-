...
export default function RewardsManagement() {
  ...
  return (
    <div className="container mx-auto p-6 space-y-6" data-testid="rewards-management-page">
      ...
      <Card data-testid="quick-test-card">
        <CardHeader>
        ...
        <CardContent>
          <div className="text-center space-y-4">
            <p className="text-green-600 text-lg font-semibold">
              ✅ تم حل مشكلة الراوت! الصفحة تعمل الآن بشكل طبيعي
            </p>
            <Button 
              onClick={() => toast({ title: "نجح الاختبار", description: "الراوت يعمل والصفحة محملة بنجاح" })}
            >
              اختبار التوست
            </Button>
          </div>
