...
class MemStorage implements IStorage {
  ...
  private announcements: Announcement[] = [
    ...
    {
      id: 'ann-8',
      title: 'مركز التحويل الذكي',
      description: 'تحويل أنواع الملفات المختلفة بذكاء اصطناعي متقدم',
      buttonText: 'ابدأ التحويل',
      buttonAction: 'link',
      buttonUrl: '/convert',
      imageUrl: 'https://images.unsplash.com/photo-1555421689-491a97ff2040?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80',
      position: 8,
      isActive: true,
